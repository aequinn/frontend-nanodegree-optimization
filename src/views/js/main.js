    ...
    switch (x) {
      ...
      case "color":
        var colors = ["blue", "green", "purple", "grey", "scarlet", "NeonGreen",
          "NeonBlue", "NeonPink", "HotPink", "pink", "black", "red", "maroon",
          "silver", "golden", "yellow", "orange", "mustard", "plum", "violet",
          "cerulean", "brown", "lavender", "violet", "magenta", "chestnut",
          "rosy", "copper", "crimson", "teal", "indigo", "navy", "azure",
          "periwinkle", "brassy", "verdigris", "veridian", "tan", "raspberry",
          "beige", "sandy", "ElectricBlue", "white", "champagne", "coral",
          "cyan"
        ];
        return colors;
      case "whimsical":
      ...
      case "shiny":
        var shiny = ["sapphire", "opal", "silver", "gold", "platinum", "ruby",
          ...
          "moonlit", "bronze", "metal", "jade", "amber", "garnet", "obsidian",
          "onyx", "pearl", "copper", "sunlit", "brass", "brassy", "metallic"
        ];
        return shiny;
      case "noisy":
      ...
      case "insulting":
        var insulting = ["stupid", "idiotic", "fat", "ugly", "hideous",
          ...
          "slow", "gullible", "obtuse", "dense", "dim", "dazed", "ridiculous",
  ...
  switch (y) {
    ...
    case "music":
      var music = ["violin", "flute", "bagpipe", "guitar", "symphony",
        ...
        "stradivarius", "marimbas", "bells", "timpani", "bongos",
    ...
    case "everyday":
      var everyday = ["mirror", "knife", "fork", "spork", "spoon",
        ...
        "television", "TV", "book", "car", "truck", "soda", "door", "video",
        "game", "computer", "calender", "tree", "plant", "flower",
    ...
    case "scifi":
      var scifi = ["robot", "alien", "raygun", "spaceship", "UFO", "rocket",
        ...
        "gears", "molecule", "electron", "neutrino", "proton", "experiment",
        "photon", "apparatus", "universe", "gravity", "darkMatter",
